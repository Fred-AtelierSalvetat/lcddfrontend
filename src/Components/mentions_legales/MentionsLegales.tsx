    ...
    return (
        <div>
            <Wrapper>
                <Container>
                    ...
                    <p className='p-center'>
                        ...
                        utilisateurs et visiteurs du site <a href="https://lachainedudroit.fr" title="Visiter ce site">lachainedudroit.fr</a> les informations suivantes:
                    </p>
                </Container>
            </Wrapper>
            <Container className="container-large-space">
                ...
                <p>Adresse de courrier électronique: <a href="mailto:contact@lachainedudroit.fr" title="Envoyer un message">contact@lachainedudroit.fr</a></p>
