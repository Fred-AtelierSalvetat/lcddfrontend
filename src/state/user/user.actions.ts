...
function login(username, password) {
    ...
    /** Action creators */
    function request(user) { return { type: userActionTypes.LOGIN_USER_REQUEST, user } }
    function success(user) { return { type: userActionTypes.LOGIN_USER_SUCCESS, user } }
    function failure(error) { return { type: userActionTypes.LOGIN_USER_FAILURE, error } }
}
...
function confirmRegister(username, code) {
    return (dispatch, getState) => {
        ...
        userServices.confirmRegister(username, code)
            .then(
                user => {
    ...
    function request(user) { return { type: userActionTypes.CONFIRM_USER_REQUEST, user } }
    function success(user) { return { type: userActionTypes.CONFIRM_USER_SUCCESS, user } }
    function failure(error) { return { type: userActionTypes.CONFIRM_USER_FAILURE, error } }
}